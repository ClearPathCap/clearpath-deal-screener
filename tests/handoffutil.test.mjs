...
console.log('— §13 Wave A · A1: City / State — hardened parser (prefer blank over wrong) + structured fields —');
{
  ...
  const cases = [
    ...
    ['1 Main St, Space Center, TX 77058',                      { city: 'Space Center', state: 'TX' }, 'pass 3: a designator word followed by a NAME is not a designator'],
    ...
    ['1 Main St, Hagatna, HI 96910',                           { city: 'Hagatna', state: 'HI' }, 'pass 3: an unknown ZIP prefix (Guam 969) neither vouches nor vetoes — the whole-segment rule decides'],
    ...
    ['1 Main St, Rearden, WA 99000',                           { city: 'Rearden', state: 'WA' }, 'pass 3: a bare designator must be the WHOLE word ("Rear" ≠ "Rearden")'],
    ['',                                                      {}, 'empty'],
    [null,                                                    {}, 'null'],
  ];
