...
console.log('— §13 Wave A · A1: City / State — hardened parser (prefer blank over wrong) + structured fields —');
{
  ...
  const cases = [
    ...
    ['1 Main St, Miami, Florida 33139',                        { city: 'Miami', state: 'FL' }, 'pass 6: …an agreeing ZIP makes it confident'],
    ...
    ['100 Broadway, Brooklyn, New York',                       { city: 'Brooklyn', state: 'NY' }, 'pass 6: same, New York'],
